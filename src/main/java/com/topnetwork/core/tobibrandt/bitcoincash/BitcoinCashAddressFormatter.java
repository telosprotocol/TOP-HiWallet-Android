package com.topnetwork.core.tobibrandt.bitcoincash;

import com.topnetwork.core.tobibrandt.Utils;

import java.math.BigInteger;
import java.util.Arrays;

import static com.topnetwork.core.CurrentNetWork.Mainnet;
import static com.topnetwork.core.CurrentNetWork.Rinkeby;
...
public class BitcoinCashAddressFormatter {
	...
	public static String toCashAddress(BitcoinCashAddressType addressType, byte[] hash, String network) {
	...
	public static BitcoinCashAddressDecodedParts decodeCashAddress(String bitcoinCashAddress, String network) {
	...
	public static boolean isValidCashAddress(String bitcoinCashAddress, String moneyNetwork) {
		try {
			...
			if (bitcoinCashAddress.contains(SEPARATOR)) {
				...
				if (moneyNetwork.equals(Mainnet)) {
					if (!MAIN_NET_PREFIX.equals(prefix.toLowerCase())) {
						return false;
					}
				} else if (moneyNetwork.equals(Rinkeby)) {
				...
				prefix = moneyNetwork.equals(Mainnet) ? MAIN_NET_PREFIX : TEST_NET_PREFIX;
			}
	...
	private static byte[] getPrefixBytes(String prefixString, String network) {
	...
	private static String getPrefixString(String network) {
		switch (network) {
		case Mainnet:
