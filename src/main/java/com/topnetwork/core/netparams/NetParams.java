...
public class NetParams extends AbstractBitcoinNetParams {
...
//        bip32HeaderP2PKHpriv = 0x0488ADE4; // The 4 byte header that serializes in base58 to "xprv"
    ...
    public static synchronized NetParams get(int addressHeader, int bip32HeaderP2PKHpriv) {
        if (instance == null) {
            instance = new NetParams();
        }
        instance.addressHeader = addressHeader;
        instance.bip32HeaderP2PKHpriv = bip32HeaderP2PKHpriv;
        return instance;
    }
